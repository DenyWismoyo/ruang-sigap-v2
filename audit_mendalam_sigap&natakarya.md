...
Audit ini mencakup:
- **Frontend Natakarya**: Modul Surat, Disposisi, Tindak Lanjut, Copilot
- **Frontend Sigap**: Modul paralel Natakarya (shared architecture)
...
**File**: [`useTugasActions.ts` L150-L183](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useTugasActions.ts#L150-L183)
...
**File**: [`useTugasData.ts` L41-L44](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useTugasData.ts#L41-L44)
...
**File**: [`useSuratActions.ts` L430-L466](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts#L430-L466)
...
**File**: [`copilot/route.ts` L109](file:///d:/DENY/project/ruang-sigap-v2/src/app/api/ai/copilot/route.ts#L109) vs [`useSuratActions.ts` L298](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts#L298)
...
**File**: [`useSuratActions.ts` L63-L67](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts#L63-L67) & [`useRuangKerjaFeed.ts` L256-L261](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useRuangKerjaFeed.ts#L256-L261)
...
**File**: [`useSuratData.ts` L121-L128](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratData.ts#L121-L128)
...
**File**: [`useBawahanList.ts` L18-L67](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useBawahanList.ts#L18-L67)
...
**File**: [`RiwayatDisposisi.tsx` L57](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts#L57)
...
**File**: [`useMasterData.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useMasterData.ts)
...
**File**: [`useUserSummaries.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useUserSummaries.ts)
...
**File**: [`useSuratDetail.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratDetail.ts)
...
**File**: [`useSuratActions.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts)
...
**File**: [`useSuratActions.ts` L284-L365](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts#L284-L365)
...
**File**: [`usePemantauanTindakLanjut.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/usePemantauanTindakLanjut.ts)
...
## 🔧 TEMUAN KHUSUS SIGAP vs NATAKARYA

Setelah audit struktur direktori, **Sigap menggunakan arsitektur paralel dengan Natakarya**. Kedua app memiliki:
- `(main)/surat/` — ✅ Identik
...
| File | Peran | Lines |
|------|-------|-------|
| [`useSuratActions.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratActions.ts) | SSOT Mutasi Surat | 567 |
| [`TindakLanjutSection.tsx`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/(main)/surat/[id]/components/TindakLanjutSection.tsx) | UI Tindak Lanjut | 832 |
| [`useSuratData.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratData.ts) | Data Fetching Surat | 155 |
| [`useSuratDetail.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useSuratDetail.ts) | Aggregated Detail Query | 86 |
| [`useRuangKerjaFeed.ts`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/hooks/useRuangKerjaFeed.ts) | Feed Dashboard | 265 |
| [`NatakaryaCopilot.tsx`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/components/NatakaryaCopilot.tsx) | AI Copilot Frontend | 988 |
