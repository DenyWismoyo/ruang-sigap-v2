# 📊 Analisis Mendalam: Ruang Sigap V2 — Dashboard Natakarya
...
- **Natakarya** — Fokus ke administrasi kepegawaian & produktivitas ASN
...
## 3. Analisis Frontend (Next.js — Dashboard Natakarya)

### 3.1 Struktur Route Natakarya
...
|---|---|---|
| `NatakaryaCopilot.tsx` | ⭐⭐⭐⭐ | AI Chat, draggable, dynamic prompts dari data real |
...
## 4. Rekomendasi Pengembangan Fitur Dashboard Natakarya
...
**File yang diubah**: [`page.tsx`](file:///d:/DENY/project/ruang-sigap-v2/src/app/dashboard/natakarya/page.tsx), buat komponen baru `StatsBar.tsx`
