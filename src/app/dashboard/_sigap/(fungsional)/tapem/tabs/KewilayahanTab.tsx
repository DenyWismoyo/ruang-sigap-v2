...
import WilayahModal from '@/app/dashboard/_sigap/(fungsional)/tapem/components/WilayahModal';
import TupoksiWilayahManager from '@/app/dashboard/_sigap/(fungsional)/tapem/components/TupoksiWilayahManager';
