...
import InventarisTab from '@/app/dashboard/_sigap/(fungsional)/aset/tabs/InventarisTab';
import PeminjamanTab from '@/app/dashboard/_sigap/(fungsional)/aset/tabs/PeminjamanTab';
import MaintenanceTab from '@/app/dashboard/_sigap/(fungsional)/aset/tabs/MaintenanceTab';
