...
import JobProjectionView from '@/app/dashboard/_sigap/(main)/talenta/components/succession/JobProjectionView';
import CandidateAnalysisView from '@/app/dashboard/_sigap/(main)/talenta/components/succession/CandidateAnalysisView';
