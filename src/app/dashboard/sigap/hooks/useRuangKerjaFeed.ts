...
import { useSuratData } from '@/app/dashboard/sigap/hooks/useSuratData'; // IMPORT SSOT
...
export const useRuangKerjaFeed = () => {
  ...
  }, [unifiedSuratList, activeDisposisi, activeTugas, drafQuery.data, effectiveJabatan, isAdminOrTU, isPimpinan, topLeaderId, isAdminOnly, sentDisposisiIds]);
