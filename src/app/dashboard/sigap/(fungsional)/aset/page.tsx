...
import InventarisTab from '@/app/dashboard/sigap/(fungsional)/aset/tabs/InventarisTab';
import PeminjamanTab from '@/app/dashboard/sigap/(fungsional)/aset/tabs/PeminjamanTab';
import MaintenanceTab from '@/app/dashboard/sigap/(fungsional)/aset/tabs/MaintenanceTab';
