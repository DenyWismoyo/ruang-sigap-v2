...
import BorrowModal from '@/app/dashboard/sigap/(fungsional)/aset/components/BorrowModal';
import { useAssetData } from '@/app/dashboard/sigap/hooks/useAssetData';
import { usePeminjamanData } from '@/app/dashboard/sigap/hooks/usePeminjamanData'; // [BARU]
