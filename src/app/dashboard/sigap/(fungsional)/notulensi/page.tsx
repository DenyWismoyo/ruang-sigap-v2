...
const NotulensiDetailModal = ({ isOpen, onClose, notulensi, onEdit, onDelete, onConvertToTugas }: { 
    ...
    const handleCatatKeLogbook = async () => {
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-4xl bg-card border-border flex flex-col max-h-[90vh]">
                    ...
                    <div className="py-2">
                        ...
                        {actionItems.length > 0 && (
                            <div className="mt-6 border-t pt-4">
                                <h3 className="font-semibold text-base mb-2">Tindak Lanjut (Action Items)</h3>
                ...
                <DialogFooter className="p-4 border-t border-border flex-wrap gap-2">
                    <Button 
                        variant="outline" 
                        onClick={handleCatatKeLogbook}
                        className="border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950/40"
                    >
                        <BookOpen size={16} className="mr-2 text-blue-600" /> Catat ke Logbook
                    </Button>
                    {canManage && (
                      <>
