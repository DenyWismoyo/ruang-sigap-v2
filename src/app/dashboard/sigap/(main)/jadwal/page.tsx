            ...
            <div className="block md:hidden mb-4">
                ...
                {mobileTab === 'agenda' && (
                    <div className="mt-3 space-y-2 md:space-y-3">
                        {/* Month Selector Bar */}
                        <div className="flex items-center justify-between px-3 py-2 bg-card sg-mobile-borderless shadow-none md:shadow-sm">
                        ...
                        {!loading && agendaBulanIni.length === 0 && (
                            <div className="p-8 text-center bg-card sg-mobile-borderless border border-dashed border-border/60">
                        ...
                        {!loading && agendaBulanIni.length > 0 && agendaBulanIni.map(jadwal => {
                            ...
                            return (
                                <div 
                                    key={jadwal.id} 
                                    onClick={() => handleOpenDetailModal(jadwal)}
                                    className="p-3.5 bg-card sg-mobile-borderless border-b border-border/40 active:scale-[0.99] transition-all cursor-pointer"
                                >
