/**
 * Directory: src/app/dashboard/sigap/(main)/tugas/components/TaskReportModal.tsx
 * Status: NEW COMPONENT - TASK COMPLETION REPORT & LOGBOOK INTEGRATION
 * Deskripsi: Modal penyerahan laporan hasil kerja tugas untuk review atasan dan pencatatan logbook.
 */
...
export default function TaskReportModal({ isOpen, onClose, tugas, onSuccess }: TaskReportModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full sm:max-w-lg bg-card border-border flex flex-col p-0 gap-0 shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="p-4 md:p-5 space-y-4 max-h-[75vh] overflow-y-auto">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                id="ringkasan"
                placeholder="Contoh: Draf dokumen analisis anggaran telah selesai dikerjakan dan diverifikasi..."
                value={ringkasan}
            ...
            <div className="p-3 bg-blue-50/70 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 flex items-start space-x-2.5">
              <Checkbox
                id="autoLogbook"
                checked={autoLogbook}
              ...
              <div className="grid gap-0.5 leading-none">
                <Label htmlFor="autoLogbook" className="text-xs font-semibold text-blue-900 dark:text-blue-300 cursor-pointer">
          ...
          <div className="p-4 border-t border-border bg-muted/20 flex items-center justify-end gap-2">
            ...
            <Button
              type="submit"
              disabled={isProcessing || isUploading}
              className="text-xs h-9 px-5 font-semibold gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white"
            >
