...
import PlanCreationModal from '@/app/dashboard/sigap/components/PlanCreationModal'; 
import { cn } from '@/lib/utils';
import { TalentAssessment, TalentDataCombined } from '@/app/dashboard/sigap/hooks/useTalentData';
