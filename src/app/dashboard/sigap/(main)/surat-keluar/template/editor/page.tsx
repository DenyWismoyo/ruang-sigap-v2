                ...
                if (templateId) {
                    ...
                    if (docSnap.exists()) {
                        ...
                        setFormState({
                            ...
                            useKopSuratOpd: data.useKopSuratOpd !== false
                        });
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const payload = {
                ...
                useKopSuratOpd: formState.useKopSuratOpd,
    ...
    return (
        <div className="animate-fadeInUp max-w-6xl mx-auto pb-10">
            <div className="flex items-center gap-4 mb-6">
                <Button variant="outline" size="icon" onClick={() => router.push('/dashboard/sigap/surat-keluar')}>
                    <ArrowLeft size={18} />
                </Button>
                <div>
                            ...
                            {formState.editorMode === 'google_doc' ? (
                                <div className="space-y-4 flex-1">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-2">Pastikan akses link "Siapa saja yang memiliki link" sebagai "Pelihat".</p>
                                    </div>
                                </div>
                            ) : (
                                <div className="space-y-4 animate-fadeIn">
                                    <div className="flex items-center space-x-2 bg-muted p-2 rounded-md">
                                        <Checkbox 
                                            id="useKopSuratOpd" 
                                            checked={formState.useKopSuratOpd} 
                                            onCheckedChange={(c) => setFormState({...formState, useKopSuratOpd: c === true})} 
                                        />
                                        <Label htmlFor="useKopSuratOpd" className="text-sm font-medium cursor-pointer">
                                            Gunakan Kop Surat OPD secara Otomatis
                                        </Label>
                                    </div>
