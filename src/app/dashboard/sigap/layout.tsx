...
import './sigap.css'; // [BARU] Import isolated CSS for SIGAP
...
import GlobalSearch from '@/app/dashboard/sigap/components/GlobalSearch';
import ThemeToggleButton from '@/app/dashboard/sigap/components/ThemeToggleButton';
import Sidebar, { navItems, sections } from '@/app/dashboard/sigap/components/Sidebar'; 
...
import Toast from '@/app/dashboard/sigap/components/Toast';
...
import PageTransition from '@/app/dashboard/sigap/components/PageTransition'; 
      ...
      <div data-tenant="sigap" className="sigap-tenant-wrapper">
        ...
        <div className="flex h-screen bg-background text-foreground overflow-hidden">
          ...
          <Drawer open={isMobileDrawerOpen} onOpenChange={setIsMobileDrawerOpen}>
            ...
            <div className="fixed bottom-16 md:bottom-6 right-0 md:right-6 z-[100] flex flex-col-reverse gap-1.5 md:gap-4 items-end pointer-events-none *:pointer-events-auto">
                <SigapCopilot />
                <PortalPintarFab />
            ...
            <div className="fixed bottom-16 md:bottom-6 left-0 md:left-6 z-[100] flex flex-col-reverse gap-1.5 md:gap-4 items-start pointer-events-none *:pointer-events-auto">
                <SigapUploadFab />
            </div>
