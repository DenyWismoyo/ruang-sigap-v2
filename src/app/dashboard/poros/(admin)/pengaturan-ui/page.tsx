    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground flex items-center gap-3">
          <Palette className="w-8 h-8 text-[var(--nk-teal-mid)]" />
      ...
      <Tabs defaultValue="opd" className="w-full">
        ...
        {/* TAB TEMA OPD */}
        <TabsContent value="opd" className="space-y-4 animate-fadeInUp">
          <div className="nk-card p-6">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-foreground">Default Tema OPD</h3>
            ...
            <div>
              <div className="nk-table-wrapper overflow-hidden">
                <Table>
                  <TableHeader className="border-b border-white/10 dark:border-white/5">
                    <TableRow>
        ...
        {/* TAB TEMA USER */}
        <TabsContent value="user" className="space-y-4 animate-fadeInUp">
           <div className="nk-card p-6">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-foreground">Override Tema per Pengguna</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <Input 
                  ...
                  className="max-w-md bg-transparent border-white/10 dark:border-white/5"
                />
              </div>

              <div className="nk-table-wrapper max-h-[500px] overflow-y-auto">
                <Table>
                  <TableHeader className="sticky top-0 z-10 border-b border-white/10 dark:border-white/5 bg-background/50 backdrop-blur-md">
                    <TableRow>
