...
export default function InlineSuratDetail({ surat }: InlineSuratDetailProps) {
  ...
  return (
    <div className="mb-4 border-0 md:border md:border-[var(--border)] rounded-none md:rounded-lg md:overflow-hidden bg-transparent md:bg-card shadow-none md:shadow-[var(--nk-shadow-sm)] animate-in fade-in slide-in-from-top-2 duration-300 md:nk-card">
      {/* Header Detail - Klik untuk toggle expand/collapse */}
      <div 
        className="p-3 bg-transparent md:bg-muted/50 border-b border-border/50 md:border-b-[var(--border)] flex justify-between items-center cursor-pointer hover:bg-muted transition-colors px-0 md:px-3"
