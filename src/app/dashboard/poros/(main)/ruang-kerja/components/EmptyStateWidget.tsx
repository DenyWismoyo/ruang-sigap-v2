...
export default function EmptyStateWidget({ filterType, userName }: EmptyStateWidgetProps) {
  ...
  return (
    <Card className="relative overflow-hidden border-dashed border-0 md:border-2 border-[var(--border)] bg-transparent md:nk-glass-card p-8 md:p-12 text-center flex flex-col items-center justify-center min-h-[400px] rounded-none md:rounded-xl">
