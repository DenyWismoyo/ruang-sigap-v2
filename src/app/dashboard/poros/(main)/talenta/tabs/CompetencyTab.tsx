...
import PlanCreationModal from '@/app/dashboard/poros/(main)/talenta/components/PlanCreationModal'; 
import { cn } from '@/lib/utils';
import { TalentAssessment, TalentDataCombined } from '@/app/dashboard/poros/hooks/useTalentData';
