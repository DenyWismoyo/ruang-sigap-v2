...
import { TalentDataCombined } from '@/app/dashboard/poros/hooks/useTalentData';
import { useSuccessionData } from '@/app/dashboard/poros/hooks/useSuccessionData'; 
import JobProjectionView from '@/app/dashboard/poros/(main)/talenta/components/succession/JobProjectionView';
import CandidateAnalysisView from '@/app/dashboard/poros/(main)/talenta/components/succession/CandidateAnalysisView';
