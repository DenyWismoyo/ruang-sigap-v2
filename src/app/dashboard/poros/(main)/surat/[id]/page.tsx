...
import CachedPdfViewer from '@/app/dashboard/poros/(main)/surat/[id]/components/CachedPdfViewer';
...
const FormDisposisi = dynamic(() => import('@/app/dashboard/poros/(main)/surat/[id]/components/FormDisposisi'), { 
    ssr: false, 
    loading: () => <div className="p-4 text-center text-sm text-muted-foreground animate-pulse">Menyiapkan form disposisi...</div> 
});
const RiwayatDisposisi = dynamic(() => import('@/app/dashboard/poros/(main)/surat/[id]/components/RiwayatDisposisi'), { 
    ssr: false, 
    loading: () => <div className="p-4 text-center text-sm text-muted-foreground animate-pulse">Memuat riwayat disposisi...</div> 
});
const TindakLanjutSection = dynamic(() => import('@/app/dashboard/poros/(main)/surat/[id]/components/TindakLanjutSection'), { 
    ssr: false, 
    loading: () => <div className="p-4 text-center text-sm text-muted-foreground animate-pulse">Memuat form tindak lanjut...</div> 
});
const ActivityLogSection = dynamic(() => import('@/app/dashboard/poros/(main)/surat/[id]/components/ActivityLogSection'), { ssr: false });
const PenerimaanDisposisiModal = dynamic(() => import('@/app/dashboard/poros/(main)/surat/[id]/components/PenerimaanDisposisiModal'), { ssr: false });
const FormTugas = dynamic(() => import('@/app/dashboard/poros/(main)/tugas/components/FormTugas'), { ssr: false });


// Khusus DispositionTracker menggunakan ".then" karena bukan default export
const DispositionTracker = dynamic(() => import('@/app/dashboard/poros/(main)/surat/[id]/components/DispositionTracker').then(mod => mod.DispositionTracker), { 
    ssr: false, 
