...
function UploadSuratComponent() {
  ...
  const { jabatanMap, opdList, getUserNameByJabatanId } = useMasterData(true);
            ...
            <div className="bg-background border border-border rounded-xl shadow-2xl max-w-lg w-full p-6 animate-in zoom-in-95 fade-in duration-200">
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-3 mb-4 border border-border">
                    ...
                    <div className="pt-3 border-t border-border/80 space-y-2">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-[11px] text-[var(--nk-teal-mid)] font-medium">Bisa diubah langsung di bawah</span>
                        </div>

                        {/* Dropdown Ganti Pimpinan Langsung di Modal */}
                        <Select value={tujuanJabatanId} onValueChange={setTujuanJabatanId}>
                            <SelectTrigger className="w-full bg-background border-[var(--nk-teal-mid)]/40 focus:ring-[var(--nk-teal-mid)] font-medium text-xs sm:text-sm">
                        ...
                        <div className="p-2.5 bg-teal-50 dark:bg-teal-950/40 border border-teal-200 dark:border-teal-800/60 rounded-md">
                            <span className="text-[11px] text-muted-foreground block font-medium">Surat akan masuk ke Ruang Kerja:</span>
                            <div className="font-bold text-teal-800 dark:text-teal-200 text-sm mt-0.5 flex items-center gap-1.5">
                ...
                <div className="flex gap-3 justify-end">
                    ...
                    <Button 
                        ...
                        className="min-w-[140px] bg-[var(--nk-teal-mid)] hover:bg-[var(--nk-teal-dark)] text-white disabled:opacity-50"
                    >
