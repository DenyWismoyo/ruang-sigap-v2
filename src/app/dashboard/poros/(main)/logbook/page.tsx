...
import FormTugas from '@/app/dashboard/poros/(main)/tugas/components/FormTugas';
import { useGoogleDriveUploader, UploadStatus } from '@/app/dashboard/poros/hooks/useGoogleDriveUploader';
        ...
        <div className="p-3.5 nk-card border border-[var(--border)] shadow-[var(--nk-shadow-sm)] flex items-start gap-3 group transition-all duration-200 hover:shadow-md">
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                    ...
                    {k.aktivitasNama && (
                        <span className="text-[10px] font-semibold text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/50 border border-teal-200 dark:border-teal-900/60 px-2 py-0.5 rounded-full flex items-center gap-1">
                            ⭐ {k.aktivitasNama}
                        </span>
                    )}
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 mt-2">
                    {k.tugasTerkaitId && (
                        <Button asChild variant="link" size="sm" className="h-auto p-0 text-xs text-[var(--nk-teal-mid)]">
                            <Link href={`/dashboard/poros/tugas`}>
                    ...
                    {k.suratTerkaitId && (
                        <Button asChild variant="link" size="sm" className="h-auto p-0 text-xs text-blue-600">
                            <Link href={`/dashboard/poros/surat/${k.suratTerkaitId}`}>
            ...
            <div className="flex items-center gap-1 shrink-0">
                <Button
                    ...
                    className="h-7 px-2 text-xs text-amber-500 hover:text-amber-400 hover:bg-amber-500/10 border-amber-500/30 bg-amber-500/5 flex items-center gap-1 font-medium transition-colors"
                >
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => onKirimEkinerja?.(k)} className="text-amber-500 focus:text-amber-400 font-medium">
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-4 pb-32 md:pb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <NkCard className="p-3.5 rounded-xl flex flex-col justify-between border-[var(--nk-glass-border)] bg-[var(--nk-surface-2)]">
                    ...
                    <Progress value={dailyStats.percent} className="h-2 mb-1.5 bg-[var(--nk-surface-3)]" />
                ...
                <NkCard className="p-3.5 rounded-xl flex flex-col justify-between border-[var(--nk-glass-border)] bg-[var(--nk-surface-2)]">
                    <div className="flex items-center justify-between text-xs text-muted-foreground mb-1">
                        ...
                        {dailyStats.isTargetMet ? (
                            ...
                            <Badge variant="outline" className="text-[10px] font-medium border-amber-500/40 text-amber-500 bg-amber-500/10">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2.5 pt-1">
                ...
                <Button
                    ...
                    className="text-xs font-semibold text-muted-foreground hover:text-foreground h-8 px-2.5 ml-auto flex items-center gap-1.5 border border-dashed border-[var(--nk-glass-border)] rounded-lg hover:bg-muted/10"
                >
            ...
            <div className="space-y-3 pt-2">
                <div className="flex items-center justify-between border-b border-[var(--nk-glass-border)] pb-2">
                    <div className="flex items-center gap-1.5">
                        <Button
                            ...
                            className={`h-8 text-xs font-semibold rounded-lg px-3 ${filterStatus === 'all' ? 'bg-[var(--nk-teal-mid)] text-white' : ''}`}
                        >
                        ...
                        <Button
                            ...
                            className={`h-8 text-xs font-semibold rounded-lg px-3 ${filterStatus === 'uncompleted' ? 'bg-[var(--nk-teal-mid)] text-white' : ''}`}
                        >
                        ...
                        <Button
                            ...
                            className={`h-8 text-xs font-semibold rounded-lg px-3 ${filterStatus === 'completed' ? 'bg-[var(--nk-teal-mid)] text-white' : ''}`}
                        >
                ...
                {loading ? (
                    <div className="p-12 text-center text-muted-foreground space-y-2">
                        <Loader2 size={24} className="animate-spin mx-auto text-[var(--nk-teal-mid)]" />
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
                            {filterStatus !== 'all' ? (
                                <Button 
                                    ...
                                    variant="outline" 
                                    onClick={() => setFilterStatus('all')}
                                    className="text-xs font-semibold border-[var(--nk-glass-border)]"
                                >
                                ...
                                <>
                                    <Button
                                        size="sm"
                                        onClick={() => setIsAddModalOpen(true)}
                                        className="bg-[var(--nk-teal-mid)] hover:bg-[var(--nk-deep)] text-white text-xs font-semibold h-9 px-3.5"
                                    >
