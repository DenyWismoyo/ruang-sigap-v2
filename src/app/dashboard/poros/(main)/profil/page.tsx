...
import DelegasiWidget from '@/app/dashboard/poros/components/DelegasiWidget';
...
export default function ProfilPage() {
    ...
    const handleConnectGoogle = () => {
        if (userProfile) {
            const statePayload = JSON.stringify({ userId: userProfile.nip, redirectUrl: '/dashboard/poros/profil' });
        ...
        if (userProfile) {
            setConfirmModal({
                ...
                onConfirm: () => {
                    ...
                    window.location.href = `/api/google/disconnect?userId=${userProfile.nip}&redirectUrl=/dashboard/poros/profil`;
                },
            });
        }
    };
