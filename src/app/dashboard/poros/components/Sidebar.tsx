...
export const navItems: NavItem[] = [
  ...
  {
    href: "/dashboard/poros/laporan-langganan",
  ...
  {
    href: "/dashboard/poros/dokumen-penagihan",
    label: "Dokumen Penagihan",
    icon: FileText,
    allowedRoles: ["super_admin"],
    section: "analitika",
    colorClass: "text-blue-600",
  ...
  {
    href: "/dashboard/poros/pengaturan/users",
  ...
  {
    href: "/dashboard/poros/pengaturan/opd",
    label: "Master OPD",
    icon: Building,
    allowedRoles: ["super_admin"],
    section: "administrasi",
  ...
  {
    href: "/dashboard/poros/pengaturan/jabatan",
  ...
  {
    href: "/dashboard/poros/pengaturan-ui",
  ...
  {
    href: "/dashboard/poros/feedback-admin",
  ...
  ({
    ...
    return (
      <motion.aside
        ...
        className="relative w-20 poros-sidebar text-foreground flex flex-col h-full z-50"
      >
