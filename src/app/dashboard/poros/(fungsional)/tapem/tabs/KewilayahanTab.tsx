...
import { useTapemData } from '@/app/dashboard/poros/hooks/useTapemData';
import { Wilayah } from '@/types/index';
import WilayahModal from '@/app/dashboard/poros/(fungsional)/tapem/components/WilayahModal';
import TupoksiWilayahManager from '@/app/dashboard/poros/(fungsional)/tapem/components/TupoksiWilayahManager';
