...
import InventarisTab from '@/app/dashboard/poros/(fungsional)/aset/tabs/InventarisTab';
import PeminjamanTab from '@/app/dashboard/poros/(fungsional)/aset/tabs/PeminjamanTab';
import MaintenanceTab from '@/app/dashboard/poros/(fungsional)/aset/tabs/MaintenanceTab';
