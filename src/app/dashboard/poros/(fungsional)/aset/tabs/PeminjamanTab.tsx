...
import BorrowModal from '@/app/dashboard/poros/(fungsional)/aset/components/BorrowModal';
import { useAssetData } from '@/app/dashboard/poros/hooks/useAssetData';
import { usePeminjamanData } from '@/app/dashboard/poros/hooks/usePeminjamanData'; // [BARU]
