...
import { usePelayananData } from '@/app/dashboard/poros/hooks/usePelayananData';
...
import { TandaTerimaLayananPdf } from '@/app/dashboard/poros/(fungsional)/pelayanan/components/TandaTerimaLayananPdf'; 
