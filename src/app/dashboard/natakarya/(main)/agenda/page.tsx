  ...
  return (
    <div className="animate-fadeInUp">
        ...
        <JadwalDetailModal
            ...
            isAdmin={isAdminOrTU} 
            onApprove={(id) => handleApprove(id, () => setIsDetailModalOpen(false))} 
            onReject={(id, reason) => handleReject(id, reason, () => setIsDetailModalOpen(false))}
            onEdit={() => {}}
            onDelete={(id) => handleDelete(id, () => setIsDetailModalOpen(false))}
        />
    </div>
  );
}
