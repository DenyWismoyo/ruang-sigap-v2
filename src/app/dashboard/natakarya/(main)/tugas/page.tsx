...
import {
  NkCard,
  NkPageHeader,
} from "@/app/dashboard/natakarya/components/NkCard";
...
import {
  ...
  TaskTypeFilter,
} from "@/app/dashboard/natakarya/hooks/useTugasData";
import { useTugasActions } from "@/app/dashboard/natakarya/hooks/useTugasActions";
      ...
      <DialogContent className="sm:max-w-2xl bg-card border-border">
        ...
        <ScrollArea className="max-h-[70vh] p-1">
          <div className="space-y-4 text-foreground/90 pr-4">
            ...
            <p>
              Pusat Komando Tugas adalah tempat Anda mengelola seluruh
              pekerjaan, baik yang Anda terima dari atasan maupun yang Anda
              delegasikan ke tim.
            </p>
...
export default function TugasSayaPage() {
  ...
  const [activeStatusTab, setActiveStatusTab] =
    useState<TaskStatusFilter>("Baru");
  const [viewMode, setViewMode] = useState<"list" | "board">("list");
  const [assignmentFilter, setAssignmentFilter] =
    useState<TaskAssignmentFilter>("all");
  ...
  return (
    <div className="animate-fadeInUp">
      ...
      <NkPageHeader
        ...
        subtitle="Pusat Komando Tugas adalah tempat Anda mengelola seluruh pekerjaan"
        icon={ClipboardCheck}
        actions={
          <div className="flex items-center space-x-2 md:space-x-4 flex-shrink-0">
            <Button
              ...
              title="Bantuan"
              className="text-muted-foreground hover:text-[var(--nk-teal-mid)] bg-[var(--nk-surface-3)]"
            >
              <HelpCircle size={20} />
            </Button>
            <Button
            ...
            <Button
              ...
              className="w-full md:w-auto bg-[var(--nk-teal-mid)] hover:bg-[var(--nk-deep)] shadow-sm text-white"
            >
      ...
      {/* Filter Desktop */}
      <NkCard className="hidden md:flex p-4 mb-6 items-center gap-4">
        <div className="text-sm font-semibold">Tampilkan:</div>
        <Select
          value={assignmentFilter}
          onValueChange={(v) => setAssignmentFilter(v as any)}
        >
          <SelectTrigger className="w-[180px] bg-[var(--nk-surface-3)] border-[var(--nk-glass-border)]">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
        ...
        <div className="ml-auto flex bg-[var(--nk-surface-3)] rounded-lg p-1 border border-[var(--nk-glass-border)]">
          <Button
            variant={viewMode === "list" ? "default" : "ghost"}
            size="sm"
            onClick={() => setViewMode("list")}
            className={`rounded-md ${viewMode === "list" ? "bg-[var(--nk-teal-mid)] text-white hover:bg-[var(--nk-deep)]" : ""}`}
          >
            List
          </Button>
          <Button
            ...
            className={`rounded-md ${viewMode === "board" ? "bg-[var(--nk-teal-mid)] text-white hover:bg-[var(--nk-deep)]" : ""}`}
          >
            Board
          </Button>
        </div>
