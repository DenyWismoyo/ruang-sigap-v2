...
import PlanCreationModal from '@/app/dashboard/natakarya/(main)/talenta/components/PlanCreationModal'; 
import { cn } from '@/lib/utils';
import { TalentAssessment, TalentDataCombined } from '@/app/dashboard/natakarya/hooks/useTalentData';
