...
import { TalentDataCombined } from '@/app/dashboard/natakarya/hooks/useTalentData';
import { useSuccessionData } from '@/app/dashboard/natakarya/hooks/useSuccessionData'; 
import JobProjectionView from '@/app/dashboard/natakarya/(main)/talenta/components/succession/JobProjectionView';
import CandidateAnalysisView from '@/app/dashboard/natakarya/(main)/talenta/components/succession/CandidateAnalysisView';
