...
import { MatrixBox } from '@/app/dashboard/natakarya/(main)/talenta/components/MatrixBox';
import { UserProfile } from '@/types';
import { TalentAssessment } from '@/app/dashboard/natakarya/hooks/useTalentData';
