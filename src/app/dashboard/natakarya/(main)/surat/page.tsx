...
import { useSuratData } from '@/app/dashboard/natakarya/hooks/useSuratData';
...
import { useSuratActions, TindakLanjutPayload } from '@/app/dashboard/natakarya/hooks/useSuratActions'; 
import { useUserSuratSummary } from '@/app/dashboard/natakarya/hooks/useUserSummaries'; 
...
const CachedPdfViewer = dynamic(() => import('@/app/dashboard/natakarya/(main)/surat/[id]/components/CachedPdfViewer'), { 
    ssr: false, 
