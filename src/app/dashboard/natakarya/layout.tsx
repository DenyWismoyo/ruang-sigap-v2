...
import './natakarya.css'; // [BARU] Import isolated CSS for NATAKARYA
...
import GlobalSearch from '@/app/dashboard/natakarya/components/GlobalSearch';
import ThemeToggleButton from '@/app/dashboard/natakarya/components/ThemeToggleButton';
import Sidebar, { navItems, sections } from '@/app/dashboard/natakarya/components/Sidebar'; 
import BottomNavBar from '@/app/dashboard/natakarya/components/BottomNavBar';       
import MobileMenuSheet from '@/app/dashboard/natakarya/components/MobileMenuSheet'; 
import MegaMenuPanel from '@/app/dashboard/natakarya/components/MegaMenuPanel';     
import SmartFab from '@/app/dashboard/natakarya/components/SmartFab'; // [BARU] Import SmartFab
import NatakaryaCopilot from '@/app/dashboard/natakarya/components/NatakaryaCopilot'; // [BARU] AI Copilot

import { app, db } from '@/lib/firebase'; 
import { getMessaging, onMessage } from "firebase/messaging"; 
import { getFCMToken } from '@/lib/firebase-messaging';
import { doc, updateDoc, arrayUnion } from 'firebase/firestore';
import Toast from '@/app/dashboard/natakarya/components/Toast';
import FullPageLoader from '@/app/dashboard/natakarya/components/FullPageLoader';
import ConfirmModal from '@/app/dashboard/natakarya/components/ConfirmModal';
import PageTransition from '@/app/dashboard/natakarya/components/PageTransition'; 
        ...
        <div className="flex h-screen text-foreground overflow-hidden">
          ...
          <Drawer open={isMobileDrawerOpen} onOpenChange={setIsMobileDrawerOpen}>
            <div className="flex-1 flex flex-col overflow-hidden relative">
              ...
              <header className="sticky top-0 z-30 flex items-center justify-between px-4 lg:px-6 natakarya-header h-[60px] transition-all duration-300 border-l-[3px] border-l-[var(--nk-deep)]">
            ...
            <DrawerContent className="md:hidden h-[85vh]">
                <DrawerHeader className="text-left px-6 border-b border-border pb-4">
                    ...
                    <DrawerDescription>Akses cepat ke seluruh modul NATAKARYA.</DrawerDescription>
                </DrawerHeader>
                <MobileMenuSheet 
                    userProfile={userProfile} 
                    jabatanProfile={jabatanProfile} 
