...
import JadwalDetailModal from '@/app/dashboard/natakarya/(main)/jadwal/components/JadwalDetailModal'; 
...
import { useAgendaData } from '@/app/dashboard/natakarya/hooks/useAgendaData';
