...
import { useKeuanganData } from '@/app/dashboard/natakarya/hooks/useKeuanganData';
...
import QrAuditModal from '@/app/dashboard/natakarya/(fungsional)/keuangan/components/QrAuditModal';
