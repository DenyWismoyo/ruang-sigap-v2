...
import { useTapemData } from '@/app/dashboard/natakarya/hooks/useTapemData';
import { Wilayah } from '@/types/index';
import WilayahModal from '@/app/dashboard/natakarya/(fungsional)/tapem/components/WilayahModal';
import TupoksiWilayahManager from '@/app/dashboard/natakarya/(fungsional)/tapem/components/TupoksiWilayahManager';
