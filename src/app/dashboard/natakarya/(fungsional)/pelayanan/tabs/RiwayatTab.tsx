...
import { usePelayananData } from '@/app/dashboard/natakarya/hooks/usePelayananData';
...
import { TandaTerimaLayananPdf } from '@/app/dashboard/natakarya/(fungsional)/pelayanan/components/TandaTerimaLayananPdf'; 
