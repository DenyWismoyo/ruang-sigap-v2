...
import InventarisTab from '@/app/dashboard/natakarya/(fungsional)/aset/tabs/InventarisTab';
import PeminjamanTab from '@/app/dashboard/natakarya/(fungsional)/aset/tabs/PeminjamanTab';
import MaintenanceTab from '@/app/dashboard/natakarya/(fungsional)/aset/tabs/MaintenanceTab';
