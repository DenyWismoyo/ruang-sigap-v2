...
import BorrowModal from '@/app/dashboard/natakarya/(fungsional)/aset/components/BorrowModal';
import { useAssetData } from '@/app/dashboard/natakarya/hooks/useAssetData';
import { usePeminjamanData } from '@/app/dashboard/natakarya/hooks/usePeminjamanData'; // [BARU]
