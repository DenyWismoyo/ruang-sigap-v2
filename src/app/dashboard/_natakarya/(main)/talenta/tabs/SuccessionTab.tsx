...
import JobProjectionView from '@/app/dashboard/_natakarya/(main)/talenta/components/succession/JobProjectionView';
import CandidateAnalysisView from '@/app/dashboard/_natakarya/(main)/talenta/components/succession/CandidateAnalysisView';
