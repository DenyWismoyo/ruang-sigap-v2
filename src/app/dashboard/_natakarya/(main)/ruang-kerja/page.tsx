...
import AgendaTimeline from '@/app/dashboard/_natakarya/(main)/ruang-kerja/components/AgendaTimeline'; 
import VisionaryFeed from '@/app/dashboard/_natakarya/(main)/ruang-kerja/components/VisionaryFeed'; 
import RuangKerjaSkeleton from '@/app/dashboard/components/skeletons/RuangKerjaSkeleton'; 
import QuickAddTask from '@/app/dashboard/_natakarya/(main)/ruang-kerja/components/QuickAddTask';
import StickyNoteWidget from '@/app/dashboard/_natakarya/(main)/ruang-kerja/components/StickyNoteWidget';
import QuickLinksWidget from '@/app/dashboard/_natakarya/(main)/ruang-kerja/components/QuickLinksWidget'; 
import EmptyStateWidget from '@/app/dashboard/_natakarya/(main)/ruang-kerja/components/EmptyStateWidget'; 

const QuickPreviewModal = dynamic(() => import('@/app/dashboard/_natakarya/(main)/ruang-kerja/components/QuickPreviewModal'), { ssr: false });
const QuickDisposisiModal = dynamic(() => import('@/app/dashboard/_natakarya/(main)/ruang-kerja/components/QuickDisposisiModal'), { ssr: false });
const JadwalDetailModal = dynamic(() => import('@/app/dashboard/_natakarya/(main)/jadwal/components/JadwalDetailModal'), { ssr: false });
const QuickEditTaskModal = dynamic(() => import('@/app/dashboard/_natakarya/(main)/ruang-kerja/components/QuickEditTaskModal'), { ssr: false }); 
const RuangKerjaTutorialModal = dynamic(() => import('@/app/dashboard/_natakarya/(main)/ruang-kerja/components/RuangKerjaTutorialModal'), { ssr: false });
const NotulensiFormModal = dynamic(() => import('@/app/dashboard/_natakarya/(fungsional)/notulensi/components/NotulensiFormModal'), { ssr: false });
