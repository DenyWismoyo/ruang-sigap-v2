...
import InventarisTab from '@/app/dashboard/_natakarya/(fungsional)/aset/tabs/InventarisTab';
import PeminjamanTab from '@/app/dashboard/_natakarya/(fungsional)/aset/tabs/PeminjamanTab';
import MaintenanceTab from '@/app/dashboard/_natakarya/(fungsional)/aset/tabs/MaintenanceTab';
