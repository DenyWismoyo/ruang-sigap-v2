...
import WilayahModal from '@/app/dashboard/_natakarya/(fungsional)/tapem/components/WilayahModal';
import TupoksiWilayahManager from '@/app/dashboard/_natakarya/(fungsional)/tapem/components/TupoksiWilayahManager';
